...
export function CollectInvestorScreen({
  ...
  return (
    <div className="cb-wrap">
      ...
      {step === 1 && (
        <div className="qc">
          <h4>投资概况</h4><p className="ht">请填写您的基本投资信息</p>
          ...
          <div className="br">
            <button className="bt bp" onClick={onFinish}>下一步</button>
          </div>
        </div>
      )}
      ...
      {step === 2 && (
        <div className="qc">
          <h4>确认信息</h4><p className="ht">请确认您的投资信息</p>
          <div style={{ padding: '14px', background: 'rgba(139,92,246,.05)', borderRadius: '8px', marginBottom: '10px', fontSize: '12px', color: 'var(--t3)', lineHeight: 1.8 }}>
